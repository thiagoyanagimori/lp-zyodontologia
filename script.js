...
const TECH_DATA = [
  { id:"cadcam",    cor:"#2BA4B5", imgBg:"linear-gradient(145deg,#c8e6f0,#a8d4e4)", iconKey:"cpu",
    ...
    resumo:"Fazemos sua coroa ou restauração no mesmo dia, sem moldeira, sem segunda consulta e com encaixe perfeito.",
  ...
  { id:"litetouch", cor:"#F4A51E", imgBg:"linear-gradient(145deg,#fef3c7,#fde68a)", iconKey:"zap",
    ...
    resumo:"Laser que substitui o bisturi em muitos casos: sem corte, com muito menos dor e cicatrização bem mais rápida.",
  ...
  { id:"sedacao",   cor:"#4C9E6B", imgBg:"linear-gradient(145deg,#d1fae5,#a7f3d0)", iconKey:"heart",
    ...
    resumo:"Um gás suave que deixa você relaxado e tranquilo durante a consulta — sem medo, sem agitação e sem perder a consciência.",
  ...
  { id:"checkup",   cor:"#2BA4B5", imgBg:"linear-gradient(145deg,#cffafe,#a5f3fc)", iconKey:"scan",
    ...
    resumo:"Raio-x digital com imagem imediata, muito mais nítida e com até 80% menos radiação do que o raio-x convencional.",
  ...
  { id:"invisalign", cor:"#2BA4B5", imgBg:"linear-gradient(145deg,#e0f2fe,#bae6fd)", iconKey:"aligncenter",
    ...
    resumo:"Aparelho transparente e removível que endireita seus dentes sem bráquete, sem arame e praticamente sem ninguém notar.",
  ...
  { id:"laser",     cor:"#CF3E43", imgBg:"linear-gradient(145deg,#fee2e2,#fecaca)", iconKey:"sparkles",
    ...
    resumo:"Luz terapêutica que alivia a dor, reduz o inchaço e acelera a recuperação depois de procedimentos — sem remédio extra.",
  ...
  { id:"autoclave", cor:"#1A2E55", imgBg:"linear-gradient(145deg,#dbeafe,#bfdbfe)", iconKey:"shield",
    ...
    resumo:"Equipamento a vapor que elimina 100% de vírus, bactérias e fungos dos instrumentos antes de qualquer consulta sua.",
  ...
  { id:"ultrassom", cor:"#4C9E6B", imgBg:"linear-gradient(145deg,#d1fae5,#6ee7b7)", iconKey:"activity",
    ...
    resumo:"Limpeza por ultrassom que tira todo resíduo dos instrumentos antes da esterilização, indo a fundo onde escova não chega.",
  ...
  { id:"localizador",cor:"#F4A51E", imgBg:"linear-gradient(145deg,#fef9c3,#fef08a)", iconKey:"microscope",
    ...
    resumo:"Aparelho que mede com exatidão o interior do dente no tratamento de canal, tornando o procedimento mais rápido e seguro.",
  ...
  { id:"shofu",     cor:"#4C9E6B", imgBg:"linear-gradient(145deg,#dcfce7,#bbf7d0)", iconKey:"star",
    ...
    resumo:"Resina especial que libera flúor e cálcio continuamente, fortalecendo o dente ao redor da restauração e evitando novas cáries.",
